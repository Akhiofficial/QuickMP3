  ...
  return (
    <div className="bg-surface text-white font-body min-h-screen selection:bg-primary-dim/30 overflow-x-hidden flex flex-col items-center justify-center p-6 sm:p-8">
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        {/* Signup Container with Gradient Border */}
        <div className="relative p-px rounded-[32px] overflow-hidden shadow-2xl">
          ...
          <div className="relative bg-surface-container-low rounded-[31px] p-8 sm:p-10">
            <h2 className="text-2xl font-headline font-bold mb-8 tracking-tight">Create Account</h2>
            
            <form className="space-y-6">
              <div className="space-y-4">
                {/* Full Name */}
                <div className="group">
                  <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500 mb-2 ml-1" htmlFor="name">Full Name</label>
                ...
                {/* Password */}
                <div className="group">
                  <label className="block text-[10px] font-bold uppercase tracking-[0.2em] text-zinc-500 mb-2 ml-1" htmlFor="password">Password</label>
                  <div className="relative">
                    <input 
              ...
              <div className="flex items-center gap-3 px-1">
                <input className="w-4 h-4 rounded-full border-zinc-800 bg-zinc-950 text-primary-dim focus:ring-0 cursor-pointer appearance-none border checked:bg-primary-dim transition-all" id="terms" type="checkbox" />
                <label className="text-[11px] text-zinc-400 font-medium cursor-pointer" htmlFor="terms">
            ...
            <div className="mt-8 text-center text-[12px] font-medium">
              ...
              <Link className="text-secondary hover:underline ml-1.5" href="/login">Log In</Link>
            </div>
          </div>
        </div>
